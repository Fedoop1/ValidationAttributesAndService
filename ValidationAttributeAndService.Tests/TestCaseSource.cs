    ...
    internal static class TestCaseSource
    {
        ...
        public static IEnumerable<TestCaseData> InvalidValidationAttributeSource
        {
            get
            {
                ...
                yield return new TestCaseData(new PersonTestClassWithValidationAttributes() { Age = 25, Height = 140, Name = "Collin", LastName = "Baker", Sex = 'M', Weight = 70 });
                yield return new TestCaseData(new PersonTestClassWithValidationAttributes() { Age = 33, Height = 163, Name = "Boone", LastName = "Hill", Weight = 68 });
                yield return new TestCaseData(new PersonTestClassWithValidationAttributes() { Age = 19, Height = 190, Name = "Quintus", LastName = "Garcia", Weight = 72 });
        ...
        public static IEnumerable<TestCaseData> SetOfInvalidValidationAttributeRecords
        {
            get
            {
                yield return new TestCaseData(new List<PersonTestClassWithValidationAttributes>()
                {
                    ...
                    new PersonTestClassWithValidationAttributes() { Age = 19, Height = 190, Name = "Quintus", LastName = "Garcia", Weight = 72 },
